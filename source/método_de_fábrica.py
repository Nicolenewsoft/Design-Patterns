...
#Podemos usar o método de fábrica padrão quando criar um mesmo objeto em diversos lugares do código, 
#por exemplo, criar um perfil de usuário em diversas classes.
